...
//    private var overlayLayer: CAShapeLayer = CAShapeLayer()
    ...
    */
    ...
    fileprivate func setCircleLayer() {
        ...
        CustomViewLayer().initialize(layer: circleLayer,bounds: self.bounds)
    ...
    fileprivate func setPlusLayer() {
        ...
        CustomViewLayer().initialize(layer: plusLayer,bounds: CGRect(x: 0, y: 0, width: size, height: size))
 ...
 */
    ...
    fileprivate func setButtonImage() {
        ...
        buttonImageView.center = CGPoint(x: circleLayer.frame.size.width/2 - 5, y: circleLayer.frame.height/2 - 5)
    ...
    fileprivate func popAnimationWithOpen() {
        ...
        for item in items {
            ...
            */
            ...
            print("Ganesh x = \(item.frame.origin.x) and y = \(item.frame.origin.y)")
            print("Ganesh main x = \(layer.frame.origin.x) and y = \(frame.origin.y)")
            print("Ganesh midX = \(frame.midX)")
